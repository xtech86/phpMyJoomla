...
?>
		...
		<div class="">
			...
			<div class="">
				...
				<p class="">
					<a href="http://www.phpmyjoomla.com/forum" target="_blank"><button type="button" class="btn btn-success"><i class="icon-users" style="padding-right: 10px;"></i>FORUM</button></a>
