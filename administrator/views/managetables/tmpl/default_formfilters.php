...
<div class="span12 pmjfilters">
    <form id="frmselectserverdbtable" name="frmselectserverdbtable" method="POST">
        ...
        <div class="span5 quickfilters">
            <div><h3><?php echo JText::_('COM_PHPMYJOOMLA_QUICKCONNECTION_TEXT_TITLE_QUICKCONNECTION');?></h3>
                <div>
	                <span id="">
	                ...
	                <span id="">
	                    <i class="fa fa-database" style="font-size: 25px;margin-right: 12px;"></i><input type="text" placeholder="<?php echo JText::_('COM_PHPMYJOOMLA_QUICKCONNECTION_TEXT_PLACEHOLDER_DATABASE');?>" id="quickconn_database" name="quickconn_database" value="<?php echo $this->quickconn_database;?>">
	                </span>
                </div>
                <div>
	                <span id="">
